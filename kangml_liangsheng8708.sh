...
clear
cd /var/www/html/
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/kangml-update.zip
...
Install_Fuzai()
{
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/kangfz.sh
}

Install_App()
{
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/kangapp.sh
}
...
rpm -Uvh https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/liblz4-1.8.1.2-alt1.x86_64.rpm --force --nodeps > /dev/null 2>&1
rpm -Uvh https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/openvpn-2.4.3-1.el7.x86_64.rpm --force --nodeps > /dev/null 2>&1
...
wget -qO /etc/nginx/conf.d/default.conf https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/default.conf > /dev/null 2>&1
sed -i 's/listen 80/listen 1234/g' /etc/nginx/conf.d/default.conf > /dev/null 2>&1
systemctl start nginx > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/ixed.7.4.lin -P /opt/remi/php74/root/usr/lib64/php/modules/ > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/dnsmasq.conf -P /etc > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/openvpn.zip > /dev/null 2>&1
cd /etc/openvpn > /dev/null 2>&1
...
cd
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/shvpn > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/res.zip > /dev/null 2>&1
...
cd /bin > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/bin.zip > /dev/null 2>&1
cd /bin > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/kangml_web.zip > /dev/null 2>&1
...
cd /APP > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/kangml.apk > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/apktool.jar > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/liangsheng8708/OpenVpn-kangml4.1/main/signer.zip > /dev/null 2>&1
